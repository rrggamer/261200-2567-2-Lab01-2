...
public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener, ComponentListener, MouseWheelListener
{
    ...
    public static void main(String[] a)
    {
        ...
        Turtle cloud = new Turtle();
        Turtle firework = new Turtle();
        Turtle water = new Turtle();
        Turtle krathong = new Turtle();

        //Draw Moon
        moon.hide();
        moon.speed(2);
        moon.up();
        moon.setPosition(700,350);
        moon.dot("yellow",200);
        ...
        for (int j = 0; j < 10; j++) {
            int baseX = (j * 100);
            for (int i = 0; i < 6; i++) {
                cloud.setPosition(baseX + (i * 100), baseY);
                cloud.dot("white",100);
            }
            for (int i = 0; i < 3; i++) {
                cloud.setPosition(baseX + (i * 250), baseY + 50);
                cloud.dot("white",90);

                cloud.setPosition(baseX + (i * 150), baseY - 50);
                cloud.dot("white",90);
            }
        }
        ...
        firework.speed(2);
        firework.hide();
        String[] colors = {"red", "yellow", "blue", "green", "purple", "orange", "pink"};
        for (int k = 0; k < 5; k++) {
            firework.up();
            double startX = -1000 + Math.random() * 1000; // Random position
            double startY = -100 + Math.random() * 600;

            firework.setPosition(startX, startY);

            for (int i = 0; i < 36; i++) {
                firework.down();
                firework.setPosition(startX, startY);
                firework.penColor(colors[(int) (Math.random() * colors.length)]);
                firework.forward(80);
        ...
        water.up();
        water.hide();
        water.penColor("cornflowerblue");
        water.setPosition(-1000,-500);
        water.down();
        water.width(500);
        water.forward(2000);
        ...
        krathong.up();
        krathong.hide();
        krathong.setPosition(0, -400);
        krathong.down();
        krathong.penColor("darkolivegreen");
        krathong.width(100);
        ...
        krathong.left(45);
        krathong.width(10);
        krathong.penColor("yellow");
        krathong.forward(100);
        krathong.up();
        krathong.forward(30);
        krathong.dot("orange",20);
